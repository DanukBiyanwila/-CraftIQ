...
import img1 from '../assets/clients/img/blog/single_blog_1.png'; // adjust path and file name
                ...
                const transformedData = response.data.map((post, index) => {
                    ...
                    return {
                        ...
                        img: post.imageBase64
                            ...
                            : imageFallbacks[index % imageFallbacks.length], // fallback
                        title: post.title,
                        ...
                        commentCount: '03 Comments', // You can replace this with real data
                        date: [
                            {
